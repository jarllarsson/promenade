...
public:
	...
	struct LegFrame : public IOptimizable
	{
		LegFrame()
		{
			...
			m_stepHeighTraj.reset(PieceWiseLinear::COS_INV_NORM, 0.5f); // Stepping is defaulted to an arc
			...
			// PD settings
			m_desiredLFTorquePD.setKp_KdEQTwoSqrtKp(10.0f);
			m_FhPD.setKp_KdEQTwoSqrtKp(1.0f);
			...
			// foot
			m_tuneToeOffAngle = 0.0f;
			m_tuneFootStrikeAngle = 0.0f;
		}
